...
class BFEEGromacs:
    ...
    def generate001(self):
        ...
        if not posixpath.exists(generate_basename):
            ...
            os.makedirs(generate_basename)
        # generate the MDP file
        generateMDP(f'{sys.path[0]}/templates/gromacs/001.mdp.template',
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/001.colvars.template',
                        colvars_inputfile_basename,
        ...
        self.system.select_atoms('all').write(posixpath.join(generate_basename, 'reference.xyz'))
        # generate the shell script for making the tpr file
        generateShellScript(f'{sys.path[0]}/templates/gromacs/001.generate_tpr_sh.template',
    ...
    def generate002(self):
        ...
        if not posixpath.exists(generate_basename):
            ...
            os.makedirs(generate_basename)
        # generate the MDP file
        generateMDP(f'{sys.path[0]}/templates/gromacs/002.mdp.template',
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/002.colvars.template',
                        colvars_inputfile_basename,
                        logger=self.logger,
                        eulerTheta_width=1,
        ...
        self.system.select_atoms('all').write(posixpath.join(generate_basename, 'reference.xyz'))
        # generate the shell script for making the tpr file
        generateShellScript(f'{sys.path[0]}/templates/gromacs/002.generate_tpr_sh.template',
        ...
        shutil.copyfile(f'{sys.path[0]}/templates/gromacs/find_min_max.awk', posixpath.join(generate_basename, 'find_min_max.awk'))
        if not posixpath.exists(posixpath.join(generate_basename, 'output')):
            os.makedirs(posixpath.join(generate_basename, 'output'))
        self.logger.info(f"Generation of {generate_basename} done.")
        self.logger.info('=' * 80)
    ...
    def generate003(self):
        ...
        if not posixpath.exists(generate_basename):
            ...
            os.makedirs(generate_basename)
        # generate the MDP file
        generateMDP(f'{sys.path[0]}/templates/gromacs/003.mdp.template',
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/003.colvars.template',
                        colvars_inputfile_basename,
                        logger=self.logger,
                        eulerPhi_width=1,
    ...
    def generate004(self):
        ...
        if not posixpath.exists(generate_basename):
            ...
            os.makedirs(generate_basename)
        # generate the MDP file
        generateMDP(f'{sys.path[0]}/templates/gromacs/004.mdp.template',
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/004.colvars.template',
                        colvars_inputfile_basename,
                        logger=self.logger,
                        eulerPsi_width=1,
    ...
    def generate005(self):
        ...
        if not posixpath.exists(generate_basename):
            ...
            os.makedirs(generate_basename)
        # generate the MDP file
        generateMDP(f'{sys.path[0]}/templates/gromacs/005.mdp.template',
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/005.colvars.template',
                        colvars_inputfile_basename,
                        logger=self.logger,
    ...
    def generate006(self):
        ...
        if not posixpath.exists(generate_basename):
            ...
            os.makedirs(generate_basename)
        # generate the MDP file
        generateMDP(f'{sys.path[0]}/templates/gromacs/006.mdp.template',
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/006.colvars.template',
                        colvars_inputfile_basename,
                        logger=self.logger,
    ...
    def generate008(self):
        ...
        generateColvars(f'{sys.path[0]}/templates/gromacs/008.colvars.template',
                        colvars_inputfile_basename,
                        rmsd_bin_width=0.005,
                        rmsd_lower_boundary=0.0,
                        rmsd_upper_boundary=0.5,
